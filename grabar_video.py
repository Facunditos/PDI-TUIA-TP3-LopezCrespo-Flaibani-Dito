...
dir_videos_entrada = 'G:/Mi unidad/tecnicatura_ia/procesamiento_imagenes/PDI-TUIA-TP3-LopezCrespo-Flaibani-Dito/videos_entradas'
archivos_videos = [arc_vid for arc_vid in listdir(dir_videos_entrada)]
    
file_vid =archivos_videos[0]
ruta_file_vid = path.join(dir_videos_entrada,file_vid)
# --- Leer y grabar un video ------------------------------------------------
cap = cv2.VideoCapture('G:/Mi unidad/tecnicatura_ia/procesamiento_imagenes/PDI-TUIA-TP3-LopezCrespo-Flaibani-Dito/videos_entradas/tirada_1.mp4')  # Abre el archivo de video especificado ('tirada_1.mp4') para su lectura.
...
frames_particulares = {
    75 : [(200,200),(500,500),(0,0,255)],
    76 : [(200,200),(500,500),(0,0,255)],
    77 : [(200,200),(500,500),(0,0,255)],
    78 : [(200,200),(500,500),(0,0,255)],
    79 : [(200,200),(500,500),(0,0,255)],
    80 : [(200,200),(500,500),(0,0,255)],
    81 : [(200,200),(500,500),(0,0,255)],
...
while (cap.isOpened()): # Verifica si el video se abrió correctamente.
    ...
    if ret == True:
        if (contador_frame in frames_particulares):
            cv2.rectangle(frame, (500,500), (700,700), (0,0,255), 2) 
